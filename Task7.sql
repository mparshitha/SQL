...
SELECT COUNT(bed_count) FROM hospital;
SELECT SUM(operating_rooms) FROM hospital;
SELECT MAX(parking_available) FROM hospital;
SELECT MIN(visiting_hours) FROM hospital;
SELECT AVG(medical_specialties) FROM hospital;
SELECT *FROM hospital order by doctors_count;
SELECT *FROM hospital order by nurses_count desc;
SELECT LTRIM(pharmacists_count) FROM hospital;
SELECT RTRIM(laboratory_technicians_count) FROM hospital;
SELECT LPAD('Mercy Hospital',14,'R');
SELECT RPAD('General Hospital',16,'R');
...
SELECT COUNT(ProductionCapacity) FROM factory;
SELECT SUM(ProductionEfficiency) FROM factory;
SELECT MAX(EnergyConsumption) FROM factory;
SELECT MIN(EquipmentUtilization) FROM factory;
SELECT AVG(COGS) FROM factory;
SELECT *FROM factory order by ProductionLine;
SELECT *FROM factory order by FactoryManager desc;
SELECT LTRIM(ProductionCapacity) FROM factory;
SELECT RTRIM(ProductionEfficiency) FROM factory;
SELECT LPAD('Factory1',9,'A');
SELECT RPAD('Factory5',9,'S');